...
class _SubmitSpendingState extends State<SubmitSpending> {
  ...
  Widget build(BuildContext context) {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.fromLTRB(SizeConfig.widthMultiplier * 3.5, 0,
                  SizeConfig.widthMultiplier * 3.5, 0),
    ...
    }, viewModelBuilder: ()=> locator<SubmitSpendingViewModel>(),disposeViewModel: false,
    );
  }
}
